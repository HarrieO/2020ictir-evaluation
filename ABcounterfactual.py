...
results = {
  'model name': 'A/B-logged counterfactual',
  'model type': 'A/B-logged counterfactual',
...
all_prop_scores = np.mean(obs_prob[models_train_inv_rankings],
                          axis=0, dtype=np.float64)
all_prop_scores[np.equal(all_prop_scores, 0)] = 1.
